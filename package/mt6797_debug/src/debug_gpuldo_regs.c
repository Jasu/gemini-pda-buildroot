...
void __init mt6797_debug_gpuldo_regs_init(struct dentry *reg_dir)
{
	REGISTER_FILE(reg_dir, INFRACFG_BASE, GPULDO_CTRL_0);
	REGISTER_FILE(reg_dir, INFRACFG_BASE, GPULDO_CTRL_1);
	REGISTER_FILE(reg_dir, INFRACFG_BASE, GPULDO_CTRL_2);
	REGISTER_FILE(reg_dir, INFRACFG_BASE, GPULDO_CTRL_3);
	REGISTER_FILE(reg_dir, INFRACFG_BASE, GPULDO_CTRL_4);
	REGISTER_FILE(reg_dir, INFRACFG_BASE, GPULDO_CTRL_5);
	REGISTER_FILE(reg_dir, INFRACFG_BASE, GPULDO_CTRL_6);
	REGISTER_FILE(reg_dir, INFRACFG_BASE, GPULDO_CTRL_7);
	REGISTER_FILE(reg_dir, INFRACFG_BASE, GPULDO_CTRL_8);
	REGISTER_FILE(reg_dir, INFRACFG_BASE, GPULDO_CTRL_9);
	REGISTER_FILE(reg_dir, INFRACFG_BASE, GPULDO_CTRL_10);
}
